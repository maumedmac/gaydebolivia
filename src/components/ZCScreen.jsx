// src/components/ZCScreen.jsx
import React, { useState, useEffect } from 'react';
import { Link } from 'react-router-dom';
import { cruisingPlaces as placesData } from '../data/cruisingPlaces';
...
const ZCScreen = () => {
  ...
  return (
    <div className="home-page">
      <h1>Zona Cruising 🫂</h1>
      <p className="home-subtitle">Explora lugares específicos para cruising.</p>
