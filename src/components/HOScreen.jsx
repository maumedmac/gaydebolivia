// src/components/HOScreen.jsx
import React, { useState, useEffect } from 'react';
import { Link } from 'react-router-dom';
import { hospedajes as placesData } from '../data/hospedajes'; // Cambiado a hospedajes
...
const HOScreen = () => {
  ...
  return (
    <div className="home-page">
      <h1>Hospedajes 🏨</h1>
      <p className="home-subtitle">Encuentra un lugar amigable para quedarte.</p>
